      ...
      <Footer.Container>
        <Footer.Content>
          <Footer.Item>
            ...
            <Footer.Text>
              74, Subham Row House Laskana Kamrej Road,Surat.
            </Footer.Text>
            <Footer.List>
              <Footer.ListItem>
                <Footer.Icon name="fas fa-phone-alt" social="true" />
                <Footer.Text>+1111111111</Footer.Text>
              </Footer.ListItem>
              <Footer.ListItem>
              ...
              <Footer.ListItem>
                ...
                <Footer.Text>vatsalvasani22882@gmail.com</Footer.Text>
              </Footer.ListItem>
            </Footer.List>
          </Footer.Item>
          <Footer.Item>
            ...
            <Footer.List>
              {/* <Footer.ListItem>
                <Footer.Anchor to="/home">Home</Footer.Anchor>
              </Footer.ListItem>
              <Footer.ListItem>
